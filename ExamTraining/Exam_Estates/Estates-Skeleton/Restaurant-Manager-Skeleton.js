    ...
    var RestaurantEngine = (function () {
        ...
        var Restaurant = (function () {
            ...
            Restaurant.prototype.removeRecipe = function (recipe) {
                var idx = this._recipes.indexOf(recipe);
                this._recipes.splice(idx, 1);
            }
            
            Restaurant.prototype.printRecipeDrink = function () {
                var drinks = [];
                var arr = this._recipes;
                for (var i = 0; i < arr.length; i++) {
                    if (arr[i].constructor.name == "Drink") {
                        drinks.push(arr[i]);
                    }
                }
            ...
            Restaurant.prototype.printRecipeSalad = function () { 

                var salads = [];
                var arr = this._recipes;
                for (var i = 0; i < arr.length; i++) {
                    if (arr[i].constructor.name == "Salad") {
                        salads.push(arr[i]);
                    }
                }
            ...
            Restaurant.prototype.printRecipeDessert = function () {
                
                var desserts = [];
                var arr = this._recipes;
                for (var i = 0; i < arr.length; i++) {
                    if (arr[i].constructor.name == "Dessert") {
                        desserts.push(arr[i]);
                    }
                }
            ...
            Restaurant.prototype.printRecipeMainCourse = function () {
                
                var mc = [];
                var arr = this._recipes;
                for (var i = 0; i < arr.length; i++) {
                    if (arr[i].constructor.name == "MainCourse") {
                        mc.push(arr[i]);
                    }
                }
                
                var res = "~~~~~ MAIN COURSES ~~~~~\n";
            ...
            Restaurant.prototype.printRestaurantMenu = function () {
                ...
                if (this._recipes.length == 0) {
                    ...
                    res += Restaurant.prototype.printRecipeDrink.call(this);
                    res += Restaurant.prototype.printRecipeSalad.call(this);
                    res += Restaurant.prototype.printRecipeMainCourse.call(this);
                    res += Restaurant.prototype.printRecipeDessert.call(this);
        ...
        var Recipe = (function () {
            ...
            function Recipe(name, price, calories, serving, timeToPrepare) {
                this.setName(name);
                this.setPrice(price);
            ...
            Recipe.prototype.getServing = function () {
                return this._serving;
            }
            
            Recipe.prototype.setServing = function (serving) {
            ...
            Recipe.prototype.toString = function () { 
                var unit = this.constructor.name == "Drink"? " ml, ": " g, ";
                var  res = "==  " + 
                    this.getName() +
                     " == $" + 
        ...
        var Drink = (function () {
            ...
            function Drink(name, price, calories, serving, timeToPrepare, isCarbonated) { 
                Recipe.call(this,name, price, calories, serving, timeToPrepare);
            ...
            Drink.prototype.toString = function () {
                ...
                Carbonated: <yes / no>*/
                var carboned = this.getIsCarbonated()? "yes":"no";
                var main = Recipe.prototype.toString.call(this);
                return main + "Carbonated: " + carboned + "\n";
            }
            return Drink;
        }());
        ...
        var Meal = (function () {
            ...
            function Meal(name, price, calories, serving, timeToPrepare, isVegan) {
                Recipe.call(this, name, price, calories, serving, timeToPrepare);
            ...
            Meal.prototype.toggleVegan = function () {
                var res = this.getIsVegan() == "yes"? true:false;
                this.setIsVegan(res);
            }
            ...
            Meal.prototype.toString = function () {
                ...
                var main = vegan + Recipe.prototype.toString.call(this);
        ...
        var Dessert = (function () {
            ...
            function Dessert(name, price, calories, serving, timeToPrepare, isVegan ) {
                Meal.call(this,name, price, calories, serving, timeToPrepare, isVegan);
                this._withSugar = true;
            }

            Dessert.prototype.toggleSugar = function () {
                if (this._withSugar) {
                    return this._withSugar = false;
                } else {
                    return this._withSugar = true;
                }
            }
        ...
        var MainCourse = (function () {
            ...
            function MainCourse(name, price, calories, serving, timeToPrepare, isVegan, type) {
                Meal.call(this, name, price, calories, serving, timeToPrepare, isVegan);
                this.setType(type);
            }
        ...
        var Salad = (function () {
            ...
            function Salad(name, price, calories, serving, timeToPrepare,isPasta) {
                Meal.call(this,name, price, calories, serving, timeToPrepare,"yes");
                this.setIsPasta(isPasta);
            }

            Salad.extends(Meal);

            Salad.prototype.getIsPasta = function () {
                return this._isPasta;
            }
            
            Salad.prototype.setIsPasta = function (isPasta) {
                this._isPasta = isPasta;
            }
            
            Salad.prototype.toString = function () {
                var pasta = this.getIsPasta()?"yes":"no";
