function processEstatesAgencyCommands(commands) {
    ...
    var Garage = (function () {
        ...
        Garage.prototype.setWidth = function (width) {
            this.validateIntegerRange(width, "width", MIN_WIDTH_HEIGHT, MAX_WIDTH_HEIGHT);
            this._width = width;
        }
        ...
        Garage.prototype.setHeight = function (height) {
            this.validateIntegerRange(height, "height", MIN_WIDTH_HEIGHT, MAX_WIDTH_HEIGHT);
            this._height = height;
        }
    ...
    var EstatesEngine = (function() {
        ...
        function executeFindRentsByPriceCommand(minPrice, maxPrice) {
            ...
            Object.prototype.validateIntegerRange(maxPrice, "maxPrice", 
